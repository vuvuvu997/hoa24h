...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">Các hình thức thanh toán của Hoa 24h</h1>
      		<p>Hiện tại đối với các đơn hàng đặt hàng trực tuyến trên website, <strong>Hoa 24h</strong> có những hình thức thanh toán như sau:</p>
