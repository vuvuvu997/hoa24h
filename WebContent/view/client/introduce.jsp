...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">Bán Hoa 24h</h1>
      		<p>Chúng tôi hi vọng tất cả người tiêu dùng Việt nam sẽ được sử dụng những thụ phẩm rau củ quả tươi ngon, bổ dưỡng và an toàn nhất tại cửa hàng cung
      		 cấp thực phẩm rau củ sạch <strong>Bán Hoa 24h</strong>.Với sứ mệnh trở thành một trong những nhà cung cấp thực phẩm sạch hàng đầu tại
      		...
      		<img src="${url}/images/a.jpg" alt="Thực phẩm sạch"/> <br/> <br>
      		...
      		chất bảo quản nào bị Bộ Y Tế cấm không được sử dụng và cam kết với quý khách hàng về toàn bộ những sản phẩm được phân phối qua hệ thống phân phối  <strong>Bán Hoa 24h </strong>
      		...
      		<img src="${url}/images/aa.jpg" alt="Thực phẩm sạch" width= "1160" height= "600"/> <br/> <br>
      		<strong>Dưới đây, chúng tôi xin điểm qua những mặt hàng của Bán Hoa 24h hiện đang được rất nhiều khách hàng tin dùng và ưa chuộng:</strong><br/>
			...
			các bạn sẽ nhận được thực phẩm tươi nhất với thời gian vận chuyển ngắn nhất đáp ứng được độ tươi ngon đảm bảo vệ sinh, an toàn và ngon miệng.</p>
      		...
      		có chất lượng cao cho gia đình, <strong>Bán Hoa 24h</strong> đang trở nên hoàn thiện hơn để đem đến cho khách hàng không chỉ những sản phẩm Trái cây nhập khẩu,
