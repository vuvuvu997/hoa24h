              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/section_tc2.jpg" alt="hạt tiêu daklak">                      
                      <div class="aa-prom-content">
                        <span>Sản Phẩm độc quyền</span>
                        <h4>Các loại hoa khai trương</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/section_tc3.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sản phẩm nhập khẩu</span>
                        <h4>Các loại hoa Kỹ Niệm</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/section_tc4.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Giảm giá 25%</span>
                        <h4>Các loại hoa sinh nhât</h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/section_tc5.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sản phẩm độc quyền</span>
                        <h4>Các loại hoa bán chạy</h4>                        
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#raucu" data-toggle="tab">Hoa sinh nhật</a></li>
                    <li><a href="#hat" data-toggle="tab">Hoa khai trương</a></li>
                    <li><a href="#traicay" data-toggle="tab">Hoa tang lễ </a></li>
                    <li><a href="#matong" data-toggle="tab">Hoa kỷ niệm</a></li>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="raucu">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="${pageContext.request.contextPath}/ProductDetailController1?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img"></a>
                  ...
                  <div class="more-product">
                  	 <a class="aa-browse-btn" href="${pageContext.request.contextPath}/ProductListClientController1">Xem Tất Cả Sản Phẩm <span class="fa fa-long-arrow-right"></span></a>
                  </div>
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="${url}/images/banner_product.png" alt="banner trang chủ"></a>
          </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  <figure class="aa-blog-img">                    
                    <a href="${pageContext.request.contextPath}/BoardnewListClientDetailController1?id=${boardnew.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/news/${boardnew.image_link}" alt="Tin tức ${boardnew.title}"></a>  
                      <figcaption class="aa-blog-img-caption">
                      <span href="#"><i class="fa fa-clock-o"></i>${boardnew.created}</span>
                    </figcaption>                          
                  </figure>
                  <div class="aa-blog-info">
                    <h3 class="aa-blog-title"><a href="${pageContext.request.contextPath}/BoardnewListClientDetailController1?id=${boardnew.id}">${boardnew.title}</a></h3>
                    <p class="desc-boardnews">${boardnew.content}</p> 
                    <a href="${pageContext.request.contextPath}/BoardnewListClientDetailController1?id=${boardnew.id}" class="aa-read-mor-btn">Xem thêm<span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
              </c:forEach>
