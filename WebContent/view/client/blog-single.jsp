                ...
                <aside class="aa-blog-sidebar">
                  ...
                  <div class="aa-sidebar-widget">
                   ...
                   <c:forEach items="${boardnewlist}" var="boardnew" end="2">
                        <li>
                          <a class="aa-cartbox-img" href="${pageContext.request.contextPath}/BoardnewListClientDetailController1?id=${boardnew.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/news/${boardnew.image_link}" alt="img bài viết"></a>
                          <div class="aa-cartbox-info">
                            <h4><a href="${pageContext.request.contextPath}/BoardnewListClientDetailController1?id=${boardnew.id}"><b>${boardnew.title }</b></a></h4>
