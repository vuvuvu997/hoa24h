    ...
    <div class="container">
      <div class="row">
      	<div>
      		...
      		<strong>Các bước mua hàng trên Hoa 24h: </strong>
      		<p>
			...
			<p>Cách thức thực hiện cực đơn giản, dễ dàng, và nhanh chóng và có đầy đủ hướng dẫn sẽ tiết kiệm thời gian mua hàng của khách hàng.</p>
      		...
      		<p>Ngoài mua hàng thông qua website, khách hàng cũng có thể đặt hàng các sản phẩm của <strong>Hoa 24h</strong> qua Hotline: 19001234</p>
